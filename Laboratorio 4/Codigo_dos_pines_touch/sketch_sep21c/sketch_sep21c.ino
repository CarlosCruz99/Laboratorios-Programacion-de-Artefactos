...
void loop() {
  ...
  int valorTouch_2 = touchRead(TOUCH_PIN_2);
  ...
  if (valorTouch<UMBRAL_TOUCH) {
    ...
    display.println("Hay contacto en pin 4");

    display.fillCircle(105, 52, 5, SH110X_WHITE);
  }

  else if(valorTouch_2<UMBRAL_TOUCH){
    display.setCursor(15, 28);
    display.println("Hay contacto en pin 2");
    ...
    display.println("No hay ningun contacto");
